...
To run the build tasks:
 ...
 1. `cd /path/to/rosqueuejs/`
 2. `grunt build`

`grunt build` will concatenate and minimize the files under src and replace ros2d.js and ros2d.min.js in the build directory. It will also run the linter and test cases. This is what [Travis CI](https://travis-ci.org/RobotWebTools/rosqueuejs) runs when a Pull Request is submitted.
